...
<img class="size-full wp-image-160 aligncenter" src="https://ogunal.com/wp-content/uploads/2017/10/auth.png" alt="" width="471" height="583" />
...
<img class="size-full wp-image-163 aligncenter" src="http://sausiber.org/images/wifi-auth/11" alt="" width="873" height="460" />
...
<img class="size-full wp-image-166 aligncenter" src="http://sausiber.org/images/wifi-auth/mdk3.png" alt="" width="576" height="458" />

Saldırının sonucunda ağ içerisinde bulunan istemci içerideki yoğunluktan ötürü internete çıkamamaktadır.
<img class="size-full wp-image-167 aligncenter" src="http://sausiber.org/images/wifi-auth/cl.png" alt="" width="263" height="426" />
...
<img class="size-large wp-image-169 aligncenter" src="http://sausiber.org/images/wifi-auth/wire.png" alt="" width="1024" height="505" />

&nbsp;

Ayrıca gönderilen paketlere bakıldığında her birinin farklı bir mac adresinden gönderildiği görülür.

<img class="alignnone size-large wp-image-171" src="http://sausiber.org/images/wifi-auth/wire2.png" alt="" width="1024" height="314" />
